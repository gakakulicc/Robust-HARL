...
from harl.models.policy_models.adv_stochastic_policy import AdvStochasticPolicy


class MAPPOAdvt(OnPolicyBase):
    def __init__(self, args, obs_space, act_space, num_agents, device=torch.device("cpu")):
        ...
        self.adv_actor = AdvStochasticPolicy(args, self.obs_space, self.act_space, self.num_agents, self.device)

...
class OffPolicyHARunnerAdvt:
            ...
            if self.args["algo"] == "hasac_advt":
                ...
                if self.args["algo"] == "had3qn":
                    ...
                    for agent_id in agent_order:
                        ...
                        self.actor[agent_id].hatd3.actor_optimizer.zero_grad()
                        actor_loss.backward()
                        self.actor[agent_id].hatd3.actor_optimizer.step()
                        self.actor[agent_id].turn_off_grad()
                        actions[agent_id] = self.actor[agent_id].get_actions(
                            sp_obs[agent_id], False
                        )
    ...
    def eval_adv_state(self):
        if self.random_adversary:
            ...
            self._eval_adv_state(self.agent_adversary)

...
def truncated_normal(size, mean=0.0, std=0, threshold=2.0):
...
class PursuitEvasionEnv(gym.Env, EzPickle):
    ...
    def __init__(self,
                 ...
                 is_env=True):
        EzPickle.__init__(self, nr_pursuers, nr_evaders, obs_mode, comm_radius, world_size,world_noise, distance_bins,
    ...
    def step(self, actions):
        ...
        rewards = truncated_normal((self.nr_agents,), mean=true_rewards, std=self.reward_noise, threshold=2.0)
        ...
        # info = dict()
        info = {'true_rewards': true_rewards, 'pursuer_states': self.world.agent_states,
